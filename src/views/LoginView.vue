  ...
  <div class="min-h-[calc(100vh-4rem)] flex items-center justify-center px-4 py-12" style="background-color: var(--bg-app);">
    ...
    <div class="w-full max-w-sm animate-slide-up">
      ...
      <div class="text-center mb-10">
        ...
        <h1 class="text-2xl font-black tracking-tight" style="color: var(--text-heading);">EBF Admin Portal</h1>
        <p class="text-[10px] font-bold uppercase tracking-[0.2em] mt-2" style="color: var(--text-muted);">Management Authority</p>
      </div>
      ...
      <form @submit.prevent="handleLogin" class="card p-8 space-y-5 rounded-3xl relative overflow-hidden">
        ...
        <div>
          <label class="block text-[10px] font-bold uppercase tracking-widest mb-2" style="color: var(--text-muted);">Email Address</label>
          <input
            v-model="email"
            type="email"
        ...
        <div>
          <label class="block text-[10px] font-bold uppercase tracking-widest mb-2" style="color: var(--text-muted);">Password</label>
          <div class="relative">
            <input
              v-model="password"
        ...
        <button type="submit" :disabled="loading" class="btn-primary w-full py-3 mt-3 shadow-lg shadow-blue-600/20">
      ...
      <p class="text-center text-xs mt-8" style="color: var(--text-muted);">
        Public viewer?
        <RouterLink to="/" class="text-blue-500 hover:underline font-bold">View Standings →</RouterLink>
      </p>
