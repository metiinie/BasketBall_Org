    ...
    <div class="fixed inset-0 z-[100] flex items-center justify-center p-4" @click.self="emit('cancel')">
      ...
      <div class="relative card p-6 w-full max-w-sm animate-slide-up">
        ...
        <div class="mb-4 flex justify-center">
          <div :class="danger ? 'bg-red-500/20' : 'bg-ebf-orange/20'"
               class="w-14 h-14 rounded-2xl flex items-center justify-center">
            <svg v-if="danger" class="w-7 h-7 text-red-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/>
            </svg>
            <svg v-else class="w-7 h-7 text-ebf-orange" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
